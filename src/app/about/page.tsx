          ...
          <CardContent>
            <Tabs defaultValue="background">
              ...
              <TabsContent value="background">
                <p className="text-base text-slate-400">
                  I’m a design enthusiast, an optimistic visionary who thrives
                  on challenges and sees opportunities in problem-solving. I’m
                  curious, an avid learner and a tireless worker searching for a
                  good company environment to help me turn good ideas into
                  reality.
                </p>
              </TabsContent>
              ...
              <TabsContent value="profile">
                <p className="text-base text-slate-400">
                  Since my bachelor's degree in Communication Design from IAAD
                  University in Turin, my design journey brought me to fall in
                  love with After Effects, to deeply enjoy Visual design and
                  last but not least to discover Figma ♥️ which carried me to
                  UI-UX.
                </p>
              </TabsContent>
            </Tabs>
            ...
            <Card>
              <CardHeader>
                <div className="mb-4 flex justify-between">
                  ...
                  <div className="group relative flex size-9 flex-col items-center justify-center rounded border border-slate-500 leading-tight text-slate-400 transition-colors hover:border-slate-200">
                    {/* Add star SVG */}
                    <span className="text-base leading-3 group-hover:text-slate-200">
